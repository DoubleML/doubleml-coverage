---
title: "PLIV Models with Clustering"
...
The simulations are based on the  the [make_pliv_multiway_cluster_CKMS2021](https://docs.doubleml.org/stable/api/datasets.html#dataset-generators)-DGP with $N=25=M$ observations. Due to the linearity of the DGP, Lasso is a nearly optimal choice for the nuisance estimation.

::: {.callout-note title="Metadata"  collapse="true"}

```{python}
#| echo: false
metadata_file = '../../results/plm/pliv_late_cluster_metadata.csv'
...
df_coverage_pliv = pd.read_csv("../../results/plm/pliv_late_cluster_coverage.csv", index_col=None)
