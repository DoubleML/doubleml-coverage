...
The simulations are based on the  the [make_logistic_LZZ2020](https://docs.doubleml.org/stable/api/generated/doubleml.datasets.make_plr_CCDDHNR2018.html)-DGP with $500$ observations.

::: {.callout-note title="Metadata"  collapse="true"}

```{python}
#| echo: false
metadata_file = '../../results/plm/logistic_ate_metadata.csv'
...
df_coverage = pd.read_csv("../../results/plm/logistic_ate_coverage.csv", index_col=None)
