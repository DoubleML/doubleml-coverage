...
The simulations are based on the  the [make_pliv_CHS2015](https://docs.doubleml.org/dev/api/generated/doubleml.datasets.make_pliv_CHS2015.html)-DGP with $500$ observations. Due to the linearity of the DGP, Lasso is a nearly optimal choice for the nuisance estimation.
