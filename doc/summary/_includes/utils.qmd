...
def load_metadata_info(model_dir, coverage_file):
    ...
    if not metadata_path.exists():
        ...
        # For DID multi-period files, use the common metadata file
        elif coverage_file.startswith("did_multi"):
    ...
    if metadata_path.exists():
        try:
            ...
            if not metadata_df.empty:
                # Get date and format as Y-m-d (without leading zeros)
...
def load_and_summarize_by_category():
